...
#ifndef METROIPOSDK_SWIFT_H
#define METROIPOSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MetroIpoSdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// </ul>
IB_DESIGNABLE
SWIFT_CLASS("_TtC11MetroIpoSdk19YPDrawSignatureView")
...
///   </li>
/// </ul>
SWIFT_PROTOCOL("_TtP11MetroIpoSdk19YPSignatureDelegate_")
